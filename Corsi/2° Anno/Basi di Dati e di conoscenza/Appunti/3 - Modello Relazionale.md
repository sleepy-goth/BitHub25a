...
> **Esempio**: Dati $D_1 = \{A, B\}$ e $D_2 = \{X, Y, Z\}$, il prodotto cartesiano $D_1 \times D_2$ contiene 6 coppie: $(A,X), (A,Y), (A,Z), (B,X), (B,Y), (B,Z)$. Una possibile relazione $r \subseteq D_1 \times D_2$ è: $\{(A,X), (B,X), (B,Y)\}$.
...
> **Esempio**: `Partite ⊆ string × string × int × int`
>
> | | | | |
> |---|---|---|---|
> | Juve | Lazio | 3 | 1 |
...
> **Notazione**: Se $t$ è la prima tupla della tabella Studenti (Mario Rossi, matricola 1, voto 24), allora `t[Cognome] -> 'Rossi'`.
...
> **Cosa NON è ammesso**: due righe uguali (le n-uple devono essere distinte) e dati non omogenei nella stessa colonna.
...
> **Esempio**: Un database universitario con tre relazioni collegate tramite valori condivisi (Matricola, Codice corso):
>
> **studenti**
...
- **Indipendenza dalle strutture fisiche**: le strutture fisiche possono cambiare dinamicamente senza impatto sulle applicazioni.
...
### Schema di relazione
Uno **schema di relazione** è un nome **R** con un insieme di attributi $A_1, \ldots, A_n$:
...
> **Esempio**: Una tabella di capi di Stato con attributo `SecondoNome` avrà valori mancanti per chi non ha un secondo nome (Churchill, De Gaulle, Stalin, …).
