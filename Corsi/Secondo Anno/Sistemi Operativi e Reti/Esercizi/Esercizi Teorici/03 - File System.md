...
> [!warning] Conclusione
> La FAT deve stare **interamente** in RAM: già per un disco da 1 TB richiede **3–4 GB**, il che la rende **inadatta ai dischi grandi**. È il motivo per cui i sistemi UNIX usano gli **i-node**, di cui in memoria sta solo la quota relativa ai **file aperti** (indipendente dalla dimensione del disco). Vedi [[07 - File System#I-node vs FAT]].
...
---
**Teoria di riferimento:** [[07 - File System]] · **Altri esercizi svolti:** [[01 - Scheduling]] · [[02 - Gestione della Memoria]] · [[04 - Linux e BASH]]
