...
NOTA: adattamento minimo — versione a thread (main1) resa eseguibile: rimosso main() sequenziale di test,
main1() rinominato in main(), aggiunte inizializzazioni pthread_mutex_init e pthread_cond_init.
*/
