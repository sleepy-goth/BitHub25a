ricevimento su appuntamento email/teams 
Carlo Garoni garoni@mat.uniroma2.it

Esame scritto + orale
sulla pagina web ci sono gli esami passati
corso finisce prima di natale
corso di analisi numerica
non ha libri al di fuori delle dispense scritte da lui che cambiano ogni anno, fornite a fine corso

$\displaystyle \int_{0}^1\sqrt{ \cos x}dx$ Non calcolabile quindi approssimiamo 

Possibilista di crediti D con Matlab (messaggio su teams)
...
Cervello Bruciato continuare da video lezione 1 ora 01:07