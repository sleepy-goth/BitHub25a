...
- **Livello Logico Digitale**: formato principalmente da porte logiche che implementano la logica booleana, formate da uno o due transistor. Importante è l'elemento chiamato **registro**, una memoria a 16, 32 e 64 bit che può salvare dati.
...
- **Livello del Linguaggio Assemblativo**: semplifica la scrittura di programmi a differenza dei livelli sottostanti. I linguaggi assemblativi sono tradotti in un linguaggio virtuale inferiore e poi interpretati. Il *traduttore* utilizzato è chiamato *assemblatore*.
